 ...
 * @package    Task_Manager
 * @subpackage Task_Manager/includes
 * @author     GBOYOU Charles <oriontestorion@gmail.com>
 */
class Task_Manager {
	...
	public function __construct() {
		if ( defined( 'TASK_MANAGER_VERSION' ) ) {
			$this->version = TASK_MANAGER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'task-manager';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-task-manager-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-task-manager-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-task-manager-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-task-manager-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Task_Manager_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Task_Manager_Public( $this->get_plugin_name(), $this->get_version() );
